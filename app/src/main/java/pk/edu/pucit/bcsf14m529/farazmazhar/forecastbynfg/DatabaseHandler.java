...
public class DatabaseHandler extends SQLiteOpenHelper {
    ...
    // Table 1: Detailed weather data of cities added by user.
    ...
    // Table 2: This will contain 5 day forecast summary of cities added by user.
    ...
    public void onCreate(SQLiteDatabase sqLiteDatabase) {
        String CREATE_CITY_TABLE = "CREATE TABLE " + CITY_TABLE_NAME + "("
                ...
                + CITY_LONGITUDE + " TEXT, " + CITY_LATITUDE + " TEXT" + ")";
        ...
        String CREATE_WEATHER_TABLE = "CREATE TABLE " + WEATHER_TABLE_NAME + "("
                ...
                + WEATHER_CITY_ID + " INTEGER, " +  WEATHER_CURRENT_TEMPERATURE + " TEXT, "
                + WEATHER_HIGH_TEMPERATURE + " TEXT, " + WEATHER_LOW_TEMPERATURE + " TEXT, "
                + WEATHER_WIND + " TEXT, " + WEATHER_PRESSURE + " TEXT, " + WEATHER_CLOUDS
                + " TEXT, " + WEATHER_WEATHER + " TEXT, " + WEATHER_HUMIDITY + " TEXT" + ")";
        ...
        String CREATE_FORECAST_TABLE = "CREATE TABLE " + FORECAST_TABLE_NAME + "("
                ...
                + FORECAST_TODAY_WEATHER + " TEXT, " + FORECAST_TODAY_HIGH + " TEXT, " + FORECAST_TODAY_LOW + " TEXT, "
                + FORECAST_DAY2_WEATHER + " TEXT, " + FORECAST_DAY2_HIGH + " TEXT, " + FORECAST_DAY2_LOW + " TEXT, "
                + FORECAST_DAY3_WEATHER + " TEXT, " + FORECAST_DAY3_HIGH + " TEXT, " + FORECAST_DAY3_LOW + " TEXT, "
                + FORECAST_DAY4_WEATHER + " TEXT, " + FORECAST_DAY4_HIGH + " TEXT, " + FORECAST_DAY4_LOW + " TEXT, "
                + FORECAST_DAY5_WEATHER + " TEXT, " + FORECAST_DAY5_HIGH + " TEXT, " + FORECAST_DAY5_LOW + " TEXT"
                + ")";
    ...
    public City getCity(int id) {
        ...
        Cursor cursor = db.query(CITY_TABLE_NAME, new String[] { CITY_ID, CITY_NAME, CITY_COUNTRY, CITY_LONGITUDE, CITY_LATITUDE},
                CITY_ID + "=?" + new String[] {String.valueOf(id)}, null, null, null, null);

        if (cursor != null)
            cursor.moveToFirst();

        City city = new City(Integer.parseInt(cursor.getString(0)), cursor.getString(1), cursor.getString(2),
    ...
    public List<City> getAllCities() {
        ...
        if (cursor.moveToFirst()) {
            do {
                City city = new City(Integer.parseInt(cursor.getString(0)), cursor.getString(1),
    ...
    public int updateCity(City city) {
        ...
        return db.update(CITY_TABLE_NAME, values, CITY_ID + " =?",
                new String[] { String.valueOf(city.getId()) });
    }

    public void deleteCity(City city) {
        SQLiteDatabase db = this.getWritableDatabase();
        db.delete(CITY_TABLE_NAME, CITY_ID + " =?",
                new String[] { String.valueOf(city.getId()) });
        db.close();
    }
    ...
    public Weather getWeather(int id) {
        ...
        Cursor cursor = db.query(WEATHER_TABLE_NAME, new String[] { WEATHER_ID, WEATHER_CITY_ID, WEATHER_CURRENT_TEMPERATURE,
                        WEATHER_HIGH_TEMPERATURE, WEATHER_LOW_TEMPERATURE, WEATHER_WIND, WEATHER_PRESSURE, WEATHER_CLOUDS, WEATHER_HUMIDITY,
                        WEATHER_WEATHER}, WEATHER_ID + "=?" + new String[] {String.valueOf(id)}, null, null, null, null);

        if (cursor != null)
            cursor.moveToFirst();

        Weather weather = new Weather(Integer.parseInt(cursor.getString(0)), Integer.parseInt(cursor.getString(1)), cursor.getString(2),
    ...
    public int updateWeather(Weather weather) {
        ...
        return db.update(WEATHER_TABLE_NAME, values, WEATHER_ID + " =?",
                new String[] { String.valueOf(weather.getId()) });
    }

    public void deleteWeather(Weather weather) {
        SQLiteDatabase db = this.getWritableDatabase();
        db.delete(WEATHER_TABLE_NAME, WEATHER_ID + " =?",
                new String[] { String.valueOf(weather.getId()) });
        db.close();
    }
    ...
    public Forecast getForecast(int id) {
        ...
        Cursor cursor = db.query(FORECAST_TABLE_NAME, new String[] { FORECAST_ID, FORECAST_CITY_ID, FORECAST_TODAY_WEATHER, FORECAST_TODAY_HIGH,
                        FORECAST_TODAY_LOW, FORECAST_DAY2_WEATHER, FORECAST_DAY2_HIGH, FORECAST_DAY2_LOW, FORECAST_DAY3_WEATHER, FORECAST_DAY3_HIGH, FORECAST_DAY3_LOW,
                        FORECAST_DAY4_WEATHER, FORECAST_DAY4_HIGH, FORECAST_DAY4_LOW, FORECAST_DAY5_WEATHER, FORECAST_DAY5_HIGH, FORECAST_DAY5_LOW},
                        FORECAST_ID + "=?" + new String[] {String.valueOf(id)}, null, null, null, null);

        if (cursor != null)
            cursor.moveToFirst();

        Forecast forecast = new Forecast(Integer.parseInt(cursor.getString(0)), Integer.parseInt(cursor.getString(1)), cursor.getString(2),
                cursor.getString(3), cursor.getString(4), cursor.getString(5), cursor.getString(6), cursor.getString(7), cursor.getString(8), cursor.getString(9),
                cursor.getString(10), cursor.getString(11), cursor.getString(12), cursor.getString(13), cursor.getString(14), cursor.getString(15), cursor.getString(16));
    ...
    public void deleteForecast(Forecast forecast) {
        SQLiteDatabase db = this.getWritableDatabase();
        db.delete(FORECAST_TABLE_NAME, FORECAST_ID + " =?",
                new String[] { String.valueOf(forecast.getId()) });
        db.close();
    }
}
